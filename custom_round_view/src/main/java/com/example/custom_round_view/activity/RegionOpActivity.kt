 ...
 */
@Route(path = MOUDLE_AROUTER.REGION_OP_ACTIVITY)
class RegionOpActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_region_op_layout)
        tv_title.text = "通过 clipRect|clipPath 裁剪获取圆角view"
        iv_back_view.setOnClickListener { finish() }
        Glide.with(this).load("http://minio.898311.xyz:8900/blogimg/16383650433326.png").into(iv_clip_path_1)
